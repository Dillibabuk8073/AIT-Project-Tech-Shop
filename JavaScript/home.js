...
// let i = 0;
//  const image = ["./Assets/Carousel/boat410-1.png","./Assets/Carousel/boat518-1.png","./Assets/Carousel/sonyXb910n-1.png"];
//  const text = ["BoAt Rockerz 410 Bluetooth Headphone","Boat Rockerz 518 Bluetooth On-Ear Headphone With Mic","Sony WH-XB910N Extra BASS Noise Cancellation Headphones"];

// changeImage();

//  function changeImage(){
    
//     img.setAttribute('src', `./JavaScript${productsData[i]?.images[0]}`);
//     span.innerHTML = productsData[i]?.info;
//      shopNowBtn.innerHTML = `<a class="btn btn-primary" href="#" type="${productsData[i]?.id}" onclick="productInfo(this)">Shop Now</a>`;
